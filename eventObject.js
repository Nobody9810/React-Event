...
*/
    ...
    get eventName() { return this.eventName;} // GETS eventName ATTRIBUTE OF A PARTICULAR EVENT OBJECT
    set eventName(eventName) { this.eventName = eventName; } // SETS eventName ATTRIBUTE OF A PARTICULAR EVENT OBJECT

    get eventVenue() { return this.eventVenue; } // GETS eventVenue ATTRIBUTE OF A PARTICULAR EVENT OBJECT
    set eventVenue(eventVenue) { this.eventVenue = eventVenue; } // SETS eventVenue ATTRIBUTE OF A PARTICULAR EVENT OBJECT

    get Date() { return this.Date; } // GETS Date ATTRIBUTE CONSTRUCTOR FOR A PARTICULAR EVENT OBJECT
